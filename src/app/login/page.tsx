...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.15),transparent_55%),radial-gradient(circle_at_bottom,_rgba(236,72,153,0.12),transparent_65%)] dark:bg-[#0B0E14] dark:bg-[radial-gradient(circle_at_center,_rgba(255,255,255,0.02),transparent_70%)]">
      {/* Background overlay layer - light mode only */}
        ...
        <div className="flex flex-col lg:flex-row min-h-screen">
          ...
          <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-8 lg:p-12">
            <div className="relative z-10 max-w-lg w-full space-y-6">
              {/* Main Welcome Card */}
              <div className="rounded-[28px] border border-blue-400/30 dark:border-white/5 bg-gradient-to-br from-blue-500/25 via-blue-500/10 to-blue-500/5 dark:bg-[#18181B]/80 backdrop-blur-sm shadow-[0_30px_80px_rgba(59,130,246,0.2)] dark:shadow-none p-4 sm:p-8">
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8 lg:p-12">
            <div className="w-full max-w-md space-y-6 rounded-[28px] border border-blue-400/30 dark:border-white/5 bg-gradient-to-br from-blue-500/10 via-blue-500/5 to-transparent dark:from-[#18181B] dark:via-[#18181B] dark:to-[#18181B] backdrop-blur-md shadow-[0_30px_80px_rgba(59,130,246,0.15)] dark:shadow-none p-6 sm:p-8 transition-all duration-500 hover:shadow-[0_0_100px_rgba(59,130,246,0.4)] dark:hover:shadow-[0_0_50px_rgba(59,130,246,0.1)] hover:border-blue-500/60 dark:hover:border-white/10 bg-white/40 dark:bg-[#18181B]">
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                    className="w-full bg-white/40 dark:bg-white/5 backdrop-blur-sm border border-blue-400/30 dark:border-white/10 text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-white/30 focus-visible:border-blue-400 dark:focus-visible:border-white/20 focus-visible:ring-blue-500/50 dark:focus-visible:ring-white/10 shadow-[0_10px_30px_rgba(59,130,246,0.05)] dark:shadow-none"
                  />
                </div>
                ...
                <Button
                  type="submit"
                  className="w-full rounded-xl border border-blue-400/30 dark:border-white/10 bg-gradient-to-r from-blue-600/80 via-indigo-600/80 to-blue-600/80 dark:from-blue-600/60 dark:via-indigo-600/60 dark:to-blue-600/60 text-white shadow-[0_15px_35px_rgba(59,130,246,0.3)] dark:shadow-none backdrop-blur-sm transition duration-200 hover:border-blue-300/40 dark:hover:border-white/20 hover:from-blue-500/90 hover:via-indigo-500/90 hover:to-blue-500/90 dark:hover:from-blue-500/70 dark:hover:via-indigo-500/70 dark:hover:to-blue-500/70 mt-2"
                  disabled={isLoading}
                >
              ...
              <div className="relative pt-2">
                <div className="absolute inset-0 flex items-center pt-2">
                  <span className="w-full border-t border-blue-400/20 dark:border-white/10" />
                </div>
